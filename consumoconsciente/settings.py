"""
Django settings for consumoconsciente project.
...
ROOT_URLCONF = 'consumoconsciente.urls'


#colocar os templates da raiz em DIRS
TEMPLATES = [
    {
...
WSGI_APPLICATION = 'consumoconsciente.wsgi.application'
